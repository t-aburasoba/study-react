import { IconButton, makeStyles, Table, TableBody, TableCell, TableHead, TableRow, Paper, TableContainer } from '@material-ui/core'
...
const SetSizeArea = (props) => {
    ...
    const deleteSize = (deleteIndex) => {
        const newSize = props.sizes.filter((item, i) => i !== deleteIndex);
        props.setSizes(newSize)
    };
